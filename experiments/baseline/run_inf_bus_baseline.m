...
%   can be overlaid without modifying either third-party source tree.
    ...
    summary = struct( ...
        ...
        'resolvedGridFormingVSI', "tmp/baseline/" + caseName + ...
            "/runtime-simplus-grid-tool/+SimplusGT/+Class/GridFormingVSI.m", ...
        'inputWorkbook', ...
    ...
    save(fullfile(outputRoot, 'baseline_workspace.mat'), ...
        'Yc', 'Ynet', 'GsysSs', 'powerFlow', 'baseAngularFrequency', 'summary');
