...
At low frequencies, understood here in the synchronous reference (dq) frame,
however, non-passivity is intrinsically associated with the constant-power characteristics of converters, a property that cannot be removed. 
...
Data and code for reproducing the results are available at \cite{Repo}.
